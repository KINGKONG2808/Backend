	...
	<div id="main" class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="card my-5">
					<div
						class="card-header bg-danger text-center text-light font-weight-bold" id="contact">Contact
						List</div>
					<div class="card-body">
								...
								<tbody id="myTable">
									...
									<c:forEach var="contact" items="${contacts }">
										<tr>
											...
											<%-- /admin/edit-contact/${contact.id } --%>
											<td style="text-align: center;"><a href="#"
												class="btn btn-success btn-sm"> <span
													class="glyphicon glyphicon-edit"></span> Edit
											</a> &nbsp; <a href="#" class="btn btn-danger btn-sm"> <span
